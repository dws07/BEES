!(function (t, o) {
  ...
  function r(t, o) {
    return (
      !(!t || "string" != typeof o) &&
      !!(t.className && -1 < t.className.trim().split(/\s+/gi).indexOf(o))
    );
  }
  return (
    (o.lib = o.prototype =
      {
        ...
        buildToast: function () {
          ...
          return (
            ...
            "" !== this.options.avatar &&
              (((i = document.createElement("img")).src = this.options.avatar),
    ...
    (o.reposition = function () {
      for (
        ...
        a = !0 === r(e[s], "toastify-top") ? "toastify-top" : "toastify-bottom";
        var n = e[s].offsetHeight,
          a = a.substr(9, a.length - 1);
        (0 < window.innerWidth ? window.innerWidth : screen.width) <= 360
          ? ((e[s].style[a] = i[a] + "px"), (i[a] += n + 15))
          : !0 === r(e[s], "toastify-left")
          ? ((e[s].style[a] = t[a] + "px"), (t[a] += n + 15))
          : ((e[s].style[a] = o[a] + "px"), (o[a] += n + 15));
      }
      return this;
    }),
