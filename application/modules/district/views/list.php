        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">
                        <?php
                        $check_form = $this->crud_model->get_module_function_for_role('district', 'form');
                        if ($check_form == true) {
                            ?>
                                ...
                                foreach ($items as $key => $value) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                            $check_delete = $this->crud_model->get_module_function_for_role('district', 'soft_delete');
                                            if ($check_delete == true) {
                                                ?>
                                                <a class="btn btn-sm bg-red" data-toggle="modal"
                                                    data-target="#exampleModal<?php echo $value->id; ?>" class="btn btn-flat margin"
