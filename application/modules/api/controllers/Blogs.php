        ...
        if ($this->request_method != "GET") {
            $response=array(
                ...
                foreach($items as $key=>$val){
                    $cat_detail = $this->crud_model->get_where_single_order_by('blogs_category', array('id'=>$val->blog_cat), 'id', 'DESC');
                    $items[$key]->cat_name = isset($cat_detail->title)?$cat_detail->title:'';
                }
