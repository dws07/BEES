          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title">
                    <?php
                      $check_form = $this->crud_model->get_module_function_for_role('public_info', 'form');
                      if ($check_form == true) {
                    ?>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <?php
                              $check_delete = $this->crud_model->get_module_function_for_role('public_info', 'soft_delete');
