...
class Admin extends Auth_controller {
	...
	public function __construct()
	{
		...
		$this->redirect = 'digital_services/admin/';
	...
	{ 
        ...
        $data['page'] = 'list';
		$data['offset'] = $page;
		$data['digital_service'] = 'digital_service-all';
	...
	{ 
		...
		$data['blog_category'] = $this->crud_model->get_where_order_by('blogs_category', array('status' => '1'), 'id', 'ASC');
		$data['title'] = 'Add/Edit '.$this->title;
        $data['page'] = 'form';
		$data['digital_service'] = 'digital_service-form';
		$data = array_merge($this->data, $data);
        $this->load->view('layouts/admin/index',$data);
	}
