...
class Nepali_calendar
{
	private $bs = array(
		...
		91 => array(2091, 31, 31, 32, 31, 31, 30, 30, 30, 29, 30, 30, 30),
		92 => array(2092, 31, 32, 31, 32, 30, 31, 30, 30, 29, 30, 30, 30),
		93 => array(2093, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30),
		94 => array(2094, 31, 31, 32, 31, 31, 31, 30, 30, 29, 30, 30, 30),
		95 => array(2095, 30, 31, 32, 32, 30, 31, 30, 30, 29, 30, 30, 30),
		96 => array(2096, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30),
		97 => array(2097, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30),
		98 => array(2098, 30, 31, 32, 32, 30, 31, 30, 30, 29, 30, 30, 30),
		99 => array(2099, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30),
		100 => array(2100, 30, 32, 31, 32, 31, 30, 30, 30, 29, 30, 30, 30)
	);
	...
	public function get_time($desired_date)
	{
		...
		// 					$min=$this->convert_into_nepali_date(date("i",$from_time));
		// 					$am_pm=date("A",$from_time);
		// 					$result=$nepalidate['year'].' '.$nepalidate['nmonth'].' '.$nepalidate['date'].', '.$nepalidate['day'].''." &nbsp;";
		// 				}
		// 			}else{
		// 				if($hour<$roundhour){
		// 					$roundrslt=$roundhour-1;
		// 					if($hour >=1){
		// 						$result=($roundhour==1 || $roundrslt==2)?"१ घण्टा अगाडि ":" ".$this->convert_into_nepali_date($roundrslt)." घण्टा अगाडि ";
		// 					}else{

		// 						$result=($mins==1)?" १ मिनेट अगाडि":" ".$this->convert_into_nepali_date(round($mins))." मिनेट अगाडि";
		// 					}
		// 				}else{
		// 					if($hour >=1){
		// 						$result=($roundhour==1)?"१ घण्टा अगाडि ":" ".$this->convert_into_nepali_date($roundhour)." घण्टा अगाडि";
		// 					}else{
		// 						$result=($mins==1)?"१ मिनेट अगाडि ":" ".$this->convert_into_nepali_date(round($mins))." मिनेट अगाडि ";
		// 					}
		// 				}
	...
	private function get_english_date($m)
	{
		$m = strtolower($m);
		$eMonth = false;
		switch ($m) {
	...
	public function getenglishdate($m)
	{
		$m = strtolower($m);
		$eMonth = false;
		switch ($m) {
